/*
  ...
  gengetopt -F ptl_opts -S --set-package=portals --set-version=3.3.3-slim 
...
const char *gengetopt_args_info_usage = "Usage: portals [OPTIONS]...";
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "server") == 0)
          {
            ...
            if (update_arg((void *)&(args_info->server_flag), 0, &(args_info->server_given),
                ...
                check_ambiguity, override, 1, 0, "server", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "server-pid") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->server_pid_arg), 
                ...
                &(local_args_info.server_pid_given), optarg, 0, "98", ARG_LONGLONG,
                check_ambiguity, override, 0, 0,
                "server-pid", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "server-nid") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->server_nid_arg), 
                ...
                &(local_args_info.server_nid_given), optarg, 0, "0", ARG_LONGLONG,
                check_ambiguity, override, 0, 0,
                "server-nid", '-',
                additional_error))
              goto failure;
